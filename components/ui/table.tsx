...
/**
 * Data-dense table primitives.
 *
 * The scroll container is on the wrapper, not the body, so a wide table scrolls
 * horizontally inside its card rather than pushing the whole page sideways.
 */
